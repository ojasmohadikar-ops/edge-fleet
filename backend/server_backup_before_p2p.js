...
function runBenchmark() {
  ...
  // Benchmark must not depend on live simulation blockages.
  ...
  const improvement =
    ((results.stopAndWait.ticks - results.decentralized.ticks) /
      results.stopAndWait.ticks) * 100;
